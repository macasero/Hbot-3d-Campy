...
global meshP = 5								; X = size of mesh matrix size: 3 = 3x3 ; 5 = 5x5 ; 7 = 7x7 ; 9 = 9x9; 11 = 11 x 11
; global variables
...
; Filament Sensor
;M591 D0 P1 C"e0_stop" S1                                                ; filament runout sensor
...
; Fan2 = Chamber cam
; Chamber Sensor
M308 S5 S1 P"e1temp" Y"thermistor"  T100000 B3950 A"Cabina"	; configure sensor 0 as thermistor on pin bedtemp
M950 F2 C"!fan2+^exp.pb6" Q500 					; Fan 2 uses the Fan2 output, but we are using a PWM fan so the output needs to be inverted, also we are using PB6 as a tacho input with pullup resistor enabled
M106 P2 H5 L.3 B.5 X1 T40:65 C"ChamFAN"					; Set fan 2 PWR fan. Turns on when MCU temperature, hits 45C and full when the MCU temperature reaches 65C or any TMC2660 alarms
...
; LEDS
M950 P10 C"e1heat" Q500							;use heater 1 outupt for LED
M42 P10 S1										; turn off LEDS
